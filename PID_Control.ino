...
#include <PinChangeInterrupt.h>    //This library file can make all pins on the REV4 board as external interrupts.
...
//TB6612 pins
const int right_R1=6;    
const int right_R2=7;
const int PWM_R=5;
const int left_L1=8;
const int left_L2=9;
const int PWM_L=10;
...
//////////////////////PID parameters///////////////////////////////
double kp = 100, kd = 2;                   //angle loop parameters
double kp_speed = 120, ki_speed = 0.080, kd_speed = 0;   // speed loop parameters
